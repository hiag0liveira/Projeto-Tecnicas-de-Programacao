...
public class ExercicioDatasetPessoas {
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		while (escolha != 0) { 
			...
			case 10:
				System.out.println("Informe o nome da pessoa para buscar os seus dados:");
				@SuppressWarnings("unused") String limparBufferTeclado1 = teclado.nextLine();
				String nomePesquisado = teclado.nextLine();
				int verificarAchado = listaDePessoas.buscarPessoasPorNome(nomePesquisado);
				if (verificarAchado == -1) {
					System.out.println("Pessoa não encontrada");
				}
				else {
					System.out.println("Pessoa Encontrada");
					Pessoa PessoaBuscadaPeloNome = listaDePessoas.obterPessoa(verificarAchado);
					System.out.println("Nome: " + PessoaBuscadaPeloNome.obterNome());
					System.out.println("Descrição: " + PessoaBuscadaPeloNome.obterDescricao());
					System.out.println("Gênero: " + PessoaBuscadaPeloNome.obterGenero());
					System.out.println("País: " + PessoaBuscadaPeloNome.obterPais());
					System.out.println("Ocupação:" + PessoaBuscadaPeloNome.obterOcupacao());
					System.out.println("Data de nascimento:" + PessoaBuscadaPeloNome.obterDataDeNacimento());
					System.out.println("Data de falecimento:" + PessoaBuscadaPeloNome.obterDataDeFalecimento() + "\n\n");
				}
				break;
